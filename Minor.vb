...
Public Class TextInput
    ...
    ''' </summary>
    Property SelectedHighlightColor As Color
        Set
            SetStyleProperty(StylePropertyIds.SelectedHighlightColor, New DataTypes.StyleProperty(Value), markAsDirty:=False)
        End Set
        Get
            Return GetActiveStyle(StylePropertyIds.SelectedHighlightColor).asColor
        End Get
    End Property
...
''' </summary>
Friend Module StylePropertyIds
    Public ReadOnly SpaceAfter As String = "SpaceAfter"
    Public ReadOnly SpaceBefore As String = "SpaceBefore"
    Public ReadOnly FillColor As String = "FillColor"
    Public ReadOnly Scale As String = "Scale"
    Public ReadOnly Padding As String = "Padding"
    Public ReadOnly ShadowColor As String = "ShadowColor"
    Public ReadOnly ShadowScale As String = "ShadowScale"
    Public ReadOnly ShadowOffset As String = "ShadowOffset"
    Public ReadOnly OutlineColor As String = "OutlineColor"
    Public ReadOnly OutlineWidth As String = "OutlineWidth"
    Public ReadOnly SelectedHighlightColor As String = "SelectedHighlightColor"
End Module